...
<div class="wrapper">
    <div class="profile-background"  style="background-image: url('assets/img/lamp.jpg');">
        ...
        <div class="container">
            <div class="row owner">
                ...
                while ($result = mysqli_fetch_assoc($row)) {
                    $id = $result['fid'];
                    echo "<div class=\"col-md-2 col-md-offset-5 col-sm-4 col-sm-offset-4 col-xs-6 col-xs-offset-3 text-center\">
                    <div class=\"avatar\">
                        <img src=\"../images/" . $result['profile_image'] . "\" alt=\"Circle Image\" class=\"img-circle img-no-padding img-responsive\">
                    </div>
                    <div class=\"name\">
                        <h4>" . $result['facultyname'] . "</small></h4>
                    </div>
                </div>";
                }
                ?>
